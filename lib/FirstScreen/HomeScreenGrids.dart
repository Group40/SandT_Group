...
class HomeScreenGrids extends StatelessWidget {
  ...
  Item item4 = new Item("Youtube", 'assets/icons/youtube.png', PicGallery());
  Item item5 = new Item("Magazine", 'assets/icons/magazine.jpg', PicGallery());
  Item item6 = new Item("S&T Optics", 'assets/icons/store.png', PicGallery());
