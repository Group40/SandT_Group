...
var url = "http://10.0.2.2:8080/api/auth/signup";

/*
void sendlog(username, password) async {
  /*debugPrint('funtion called');
  var body = jsonEncode({
    'username': "as",
    'email': "as@.com", //_emailController.text;
    'password': "12345678", //_passwordController.text;
    'roles': "[\"user\"]"
  });*/
                        ...
                        Positioned(
                          ...
                          child: IconButton(
                            onPressed: () async {
                              ...
                              /*final val = SignUpl(
                                  username: "as", // _nameController.text,
                                  email: "a@a.com", //_emailController.text,
                                  password:
                                      "12345678" //_passwordController.text
                                  );
                              final result = await Signupservice.createacc(val);
                              */
                              //sendlog("admin", "12345678");
                              send();
                              _emailController.clear();
                              _passwordController.clear();
                              _nameController.clear();
